...
def afficher_menu():
    ...
    position_curseur = (curseur_valeur - curseur_min) / (curseur_max - curseur_min) * (curseur_rect.width - 20) + curseur_rect.x + 10
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if curseur_dragging:
                    ...
                    curseur_valeur = int((position_relative / (curseur_rect.width - 20)) * (curseur_max - curseur_min) + curseur_min)
